  ...
  constructor(props) {
    ...
    this.state = {
      ...
      movies: [
        ...
        {id:27, href: 'https://movie.naver.com/movie/bi/mi/basic.naver?code=184519#', photo:'/images/27.jpg', title:'비상선언 (2022)', year:'2022', director: '한재림', actors: '송강호, 이병헌, 전도연', branch: '오피셜 판타스틱 오르비타 (한재림)', synopsis: '베테랑 형사 팀장 인호(송강호)는 비행기 테러 예고 영상 제보를 받고 사건을 수사하던 중 용의자가 실제로 KI501 항공편에 타고 있음을 파악한다.딸의 치료를 위해 비행 공포증임에도 불구하고 하와이로 떠나기로 한 재혁(이병헌)은주변을 맴돌며 위협적인 말을 하는 낯선 이가 신경 쓰인다.인천에서 하와이로 이륙한 KI501 항공편에서 원인불명의 사망자가 나오고...'}
      ]
    }
  }
  componentWillMount() {
